module github.com/fernandezcuesta/function-environment-configs
...
require (
	...
	github.com/fernandezcuesta/function-patch-and-transform v0.7.1-0.20241106072055-a6a1104a182d
